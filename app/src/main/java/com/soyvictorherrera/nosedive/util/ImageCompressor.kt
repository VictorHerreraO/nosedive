...
/**
 * @see <a href="https://anilbattini.medium.com/how-to-compress-image-or-resize-image-for-android-apps-905051ddca0d">Medium Post</a>
 */
object ImageCompressor {
    ...
    fun compressBitmap(context: Context, originalImageFile: File, cb: ((File) -> Unit)? = null) {
        ...
        val file = getPicturesFile(context, originalImageFile.name)
    ...
    private fun getPicturesFile(context: Context, fileName: String, subDirectory: String = ""): File {
        return File(context.cacheDir.absolutePath.plus("/$subDirectory"), fileName)
    }
}
